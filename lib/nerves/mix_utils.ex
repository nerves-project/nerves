...
defmodule Nerves.MixUtils do
  ...
  @spec success(String.t() | [term()]) :: :ok
  def success(msg) do
    Mix.shell().info([:green, msg, :reset])
  end

  @doc "Print an info message"
  @spec info(String.t() | [term()]) :: :ok
  def info(msg) do
    Mix.shell().info(msg)
  end

  @doc "Print a warning message in yellow"
  @spec warning(String.t() | [term()]) :: :ok
  def warning(msg) do
    Mix.shell().info([:yellow, msg, :reset])
  end

  @doc "Print an error message in red"
  @spec error(String.t() | [term()]) :: :ok
  def error(msg) do
    Mix.shell().error([:red, msg, :reset])
  end
  ...
  def set_provisioning(app) when is_atom(app) do
    ...
    # TODO: This seems wrong. Is it even used???
