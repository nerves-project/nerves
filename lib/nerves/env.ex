defmodule Nerves.Env do
  ...
  def host_arch() do
    System.get_env("HOST_ARCH") || probe_arch()
  end

  defp probe_arch() do
    :erlang.system_info(:system_architecture) |> to_string() |> parse_arch()
  end
  ...
  def host_os() do
    System.get_env("HOST_OS") || probe_host_os()
  end

  defp probe_host_os() do
