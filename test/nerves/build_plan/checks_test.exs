...
defmodule Nerves.BuildPlan.ChecksTest do
  ...
  defp passing_plan() do
    env =
      ~w[AR AR_FOR_BUILD AS AS_FOR_BUILD CC CC_FOR_BUILD CFLAGS CFLAGS_FOR_BUILD CMAKE_TOOLCHAIN_FILE
           ...
           LD LD_FOR_BUILD LDFLAGS LDFLAGS_FOR_BUILD NERVES_APP NERVES_SDK_IMAGES NERVES_SDK_SYSROOT
