...
#
defmodule Mix.Tasks.Firmware.BurnTest do
  ...
  test "firmware.burn builds firmware before burning" do
    Mix.Task.reenable("firmware")
    Mix.Task.reenable("firmware.burn")

    error = assert_raise Mix.Error, fn -> Mix.Task.run("firmware.burn") end
