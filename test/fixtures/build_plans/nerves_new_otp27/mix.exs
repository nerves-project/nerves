defmodule NervesNewOtp27.MixProject do
  use Mix.Project

  @app :nerves_new_otp27
  @version "0.1.0"
  @all_targets [:rpi0]
  ...
  def application do
    [
      mod: {NervesNewOtp27.Application, []},
  ...
  defp deps do
    [
      ...
      # Restrict to OTP 27 systems
      {:nerves_system_rpi0, "~> 1.31.0", runtime: false, targets: :rpi0}
    ]
  end
