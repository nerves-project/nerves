defmodule NervesNewOtp29.MixProject do
  use Mix.Project

  @app :nerves_new_otp29
  @version "0.1.0"
  @all_targets [:rpi0]
  ...
  def application do
    [
      mod: {NervesNewOtp29.Application, []},
  ...
  defp deps do
    [
      ...
      # Restrict to OTP 29 systems
      {:nerves_system_rpi0, "~> 2.1.1", runtime: false, targets: :rpi0}
    ]
  end
